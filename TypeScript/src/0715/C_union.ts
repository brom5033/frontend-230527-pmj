...
//? 유니언
// : 값에 허용된 타입을 두개 이상의 가능한 타입으로 확장하는것
//? 내로잉
...
let idol3 = Math.random() > 0.5 ? undefined : 'LE SSERAFIM';

// idol3.toUpperCase();
// idol3.toFixed();
idol3.toString(); // toString() : number타입과 string 타입 모두 사용가능

//! 내로잉(narrowing)
// : 값이 정의, 이전에 유추된것보다 더 구체적인 타입임을 코드에서 유추하는것
...
typeof actor2 === "string" ? actor2.toUpperCase() : actor.toFixed();
